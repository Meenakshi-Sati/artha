...
function CaseStudy() {
    ...
    function handleInputContent(e, id) {
        setInputValues({ ...inputValues, [id]: e.target.value, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1DGavE7LWWwrKiD5fyG7lenXxV85pRcVj0HIf9fnB9T6RXVegLe8VEMA2CsGeJ_WxXTc&usqp=CAU", state: "published" })
    }
            ...
            <div id="case-study-content-div">
                <div id="case-study-top-div">
                    ...
                    <div id="create-entry-div">
                        <button onClick={createNewEntries} id="create-btn">+ Create New Entry</button>
                    </div>
                </div>
                ...
                {newEntry ?
                    <div id="new-entry-div">
                        <input id="id" onChange={(e) => handleInputContent(e, "id")} className="new-entry-input" type="text" placeholder="Enter  ID" />
                        <input id="title" onChange={(e) => handleInputContent(e, "title")} className="new-entry-input" type="text" placeholder="Enter Title" />
                        <input id="field" onChange={(e) => handleInputContent(e, "field")} className="new-entry-input" type="text" placeholder="Enter Field Name" />
                        <button onClick={addNewEntry} id="add-entry-btn">ADD</button>
                    </div>
                    : null
                }
...
let caseStudyObj = [
    { id: 12, title: "Login", field: "e-commerce", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1DGavE7LWWwrKiD5fyG7lenXxV85pRcVj0HIf9fnB9T6RXVegLe8VEMA2CsGeJ_WxXTc&usqp=CAU", state: "published" }
